...
static const Rule rules[] = {
	...
	{ TERMCLASS, "scratchpad", NULL,      0,            1,           -1,},
};
...
static const char *dmenucmd[] = { "j4-dmenu-desktop", "--no-generic", "--display-binary", "--term=alacritty", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,		        XK_Print,  spawn,	   SHCMD("xfce4-screenshooter -f") },
	{ MODKEY|ShiftMask,		XK_Print,  spawn,          SHCMD("xfce4-screenshooter -r") },
